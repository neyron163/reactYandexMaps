...
import { ParentContext, withParentContext } from '../Context';
...
import { IClustererOptions } from '../types';
...
export class Clusterer extends React.Component<
	ClusterProps & WithYMapsProps & WithInstanceRef & ErrorBoundaryProps & AnyObject
> {
	constructor() {
		super();
...
export default withErrorBoundary(withParentContext(withYMaps(Clusterer, true, ['Clusterer'])));
