...
import { IDataManager, ILineStringGeometry, IPolylineOptions } from '../types';
...
export const Polyline: React.FC<
	React.PropsWithChildren<
		PolylineProps & WithYMapsProps & WithInstanceRef & ErrorBoundaryProps & AnyObject
	>
> = props => {
	return <BaseGeoObject {...props} name="Polyline" />;
};

export default withErrorBoundary(withParentContext(withYMaps(Polyline, true, ['Polyline'])));
