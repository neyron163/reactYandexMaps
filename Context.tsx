...
export const YMapsApiLoaderContext = React.createContext<ApiLoader | null>(null);
...
export const withYMapsContext = <TProps extends AnyObject>(
	...
	const WithYMapsContext: React.FC<React.PropsWithChildren<TProps>> = props => (
...
export const withParentContext = <TProps extends AnyObject>(
	...
	const WithParentContext: React.FC<React.PropsWithChildren<TProps>> = props => (
